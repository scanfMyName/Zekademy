        ...
        .then((hash) => {
          ...
          newUser
            ...
            .then(() => {
              sendEmail(
                newUser.email,
                "Registration Successful in Zekademy",
                `Greetings from Zekademy! You have successfully registered in Zekademy. Please click on the link below to verify your email address. ${emailToken}`,
              ) 
                .then(() => {  
